...
local DualTab4 = Window:DrawContainerTab({ Name = "辅助", Icon = "triangle", EnableScrolling = true })
local DualTab5 = Window:DrawContainerTab({ Name = "工具", Icon = "box", EnableScrolling = true })
do
...
do
	local WorldVisualsTab = DualTab2:DrawTab({ Name = "世界视觉", Type = "Double", EnableScrolling = true })
	local WorldAmbientSection =
		WorldVisualsTab:DrawSection({ Name = "世界环境", Position = "left", EnableScrolling = true })
	local CharacterColorsSection =
		WorldVisualsTab:DrawSection({ Name = "角色颜色", Position = "right", EnableScrolling = true })
	local AuraSection =
		WorldVisualsTab:DrawSection({ Name = "变换光环", Position = "left", EnableScrolling = true })
	local TrailsSection = WorldVisualsTab:DrawSection({ Name = "轨迹", Position = "right", EnableScrolling = true })
	do
...
do
	...
	local ExploitSection = ExploitTab:DrawSection({ Name = "辅助", Position = "left", EnableScrolling = true })
...
do
	local CombatTab1 = DualTab1:DrawTab({ Name = "战斗1", Type = "Double", EnableScrolling = true })
	...
	local CombatTab2 = DualTab1:DrawTab({ Name = "战斗2", Type = "Double", EnableScrolling = true })
